...
$router->get('/created/{uuid}/{key}', '\madebyraygun\pssst\controllers\Created@handleCreated');
$router->get('/generate-totp', '\madebyraygun\pssst\controllers\GenerateTotp@generate');
$router->get('/retrieve/{uuid}/{key}', '\madebyraygun\pssst\controllers\Retrieve@handleGet');
$router->post('/retrieve/{uuid}/{key}', '\madebyraygun\pssst\controllers\Retrieve@handlePost');
$router->run();
