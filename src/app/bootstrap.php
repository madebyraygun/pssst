...
$router->get('/created/{uuid}', '\madebyraygun\pssst\controllers\Created@handleCreated');
$router->get('/generate-totp', '\madebyraygun\pssst\controllers\GenerateTotp@generate');
$router->get('/retrieve/{uuid}', '\madebyraygun\pssst\controllers\Retrieve@handleGet');
$router->post('/retrieve/{uuid}', '\madebyraygun\pssst\controllers\Retrieve@handlePost');
$router->run();
